...
namespace JqueryAjaxApp.Models
{
    public class OkulDbContext : DbContext
    {
        ...
        //    optionsBuilder.UseSqlServer(@"Data Source=HAVVA;Initial Catalog=OkulDBMVCSube2;Integrated Security=true;TrustServerCertificate=true");
        //}
